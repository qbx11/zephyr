 ...
 * @param spec SF32LB DMA DT spec
 *
 * @return 0 on success, negative errno value on failure. (see dma_start()).
 */
 ...
 * @param spec SF32LB DMA DT spec
 *
 * @return 0 on success, negative errno value on failure. (see dma_stop()).
 */
 ...
 *
 * @return 0 on success, negative errno value on failure. (see dma_reload()).
 */
 ...
 *
 * @return 0 on success, negative errno value on failure. (see dma_get_status()).
 */
