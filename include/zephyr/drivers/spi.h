 ...
 *        or NULL if none.
 *
 * @return Number of frames received in slave mode, 0 on success in
 *         master mode, negative errno value on failure.
 * @retval -ENOTSUP Some part of the spi config is not supported either by the
 ...
 * @param rx_bufs Buffer array where data to be read will be written to.
 *
 * @return Number of frames received in slave mode on success, or a
